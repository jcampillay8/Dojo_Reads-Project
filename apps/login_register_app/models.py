...
class UserManager(models.Manager):
    ...
    def loginValidator(self, userData):
            ...
            try:
                ...
                errors["loginEmail"] = f"No email address matching {userData['loginEmail']} or an account associated with this email does not exist haoaoaoaooaoaaaaaaaaaaaa  asasasasas quququququq heklllo"
